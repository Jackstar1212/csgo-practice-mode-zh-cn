...
public Plugin myinfo = {
  name = "CS:GO 练习模式",
  author = "splewis & Jackstar1212(LonelyFish88)",
  description = "一种可以通过 .setup 菜单来启动的练习模式（汉化：Jackstar1212(LonelyFish88)）",
  ...
  if (kv.JumpToKey("binary_options")) {
    if (kv.GotoFirstSubKey()) {
      ...
      do {
        ...
        kv.GetString("default", enabledString, sizeof(enabledString), "开启");
        bool enabled =
            StrEqual(enabledString, "enabled", false) || StrEqual(enabledString, "enable", false) || StrEqual(enabledString, "开启", false);
        ...
        if (kv.JumpToKey("enabled") || kv.JumpToKey("开启")) {
        ...
        if (kv.JumpToKey("disabled") || kv.JumpToKey("关闭")) {
